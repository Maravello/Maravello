...
Je suis un **développeur passionné**, actuellement en **alternance à la mairie de Montfermeil**, où je participe au développement et à l’amélioration d’outils internes.  
Mon parcours m’a permis de développer des compétences solides en **développement web**, **programmation orientée objet**, **sécurisation des données**, et **développement d’API REST**.
...
* **Développeur Web – Mairie de Montfermeil (2025 – en cours)**  
  Développement d’outils internes, amélioration d’applications existantes, intégration web, mise en place de solutions pour les services municipaux.
...
> Continuer à développer mes compétences en **développement web et applicatif**, et contribuer à des projets utiles, innovants et formateurs.
